      ...
      {!isMobile && (
        <div className="absolute inset-0 w-full h-full overflow-hidden z-[1] select-none hero-bg-video pointer-events-none">
          ...
          <video
            ...
            playsInline
            preload="auto"
            className="absolute top-0 bottom-0 left-0 right-0 lg:right-0 w-full lg:w-full h-full object-cover lg:object-contain lg:object-right object-center filter brightness-95 opacity-30 lg:opacity-100 pointer-events-none scale-[1.06] lg:scale-[1.16] origin-bottom lg:origin-bottom-right"
          >
            <source src="libst.webm" type="video/webm" />
            <source src="libst.mp4" type="video/mp4" />
